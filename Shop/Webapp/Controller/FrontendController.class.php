...
class FrontendController extends Controller{
    ...
    function _init(){ 
    	...
    	#if(strtolower(__ACTION__) == '/home/album'
    	$public = array();
    ...
    function do_login($user_id,$DeviceToken=NULL){
        $_user_mod = D('Admin/User');
        $user_info = $_user_mod->field('user_id,user_name,nick_name,u_pic,email,grade_id,logins,last_login_ip,last_login_time,score,user_token')
                     ->find($user_id);
        //分派身份
