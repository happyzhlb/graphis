...
class ApperrorController extends BackendController{
    var $_adplace_mod = null;
    var $_app_mod = null;
    function __construct(){
        parent::__construct();
        $this->ApperrorController();
    }
    function ApperrorController(){ 
        $this->_app_mod = D('Apperror');
    }
    ...
    function index(){
        ...
        $this->display('./apperror.index');
    }
    
    /** 添加App版本 */
    function add(){
        if(!IS_POST){  
            $this->display('./apperror.form');
        }else{
