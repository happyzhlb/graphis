...
class UserController extends BackendController{
    ...
    function add(){
        if(!IS_POST){
            ...
            if(!$this->_user_mod->create($data)){
             ...
             $this->success('会员添加成功',U('/Admin/User'));
        }
    }
    ...
    function edit(){
        ...
        if(!IS_POST){
            ...
            $this->success('会员编辑成功',U('/Admin/User'));
        }
    }
    ...
    function editstatus(){
        ...
        $this->success('会员状态编辑成功',U('/Admin/User'));
    }
    ...
    function drop(){
        ...
        $this->success('会员删除成功',U('/Admin/User'));
    }
